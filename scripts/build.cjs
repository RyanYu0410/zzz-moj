...
async function build(){
 const version=digest(['src/game.js','src/start-screen.js','src/preferences.js','src/i18n.js','src/scene-resources.js','src/engine.js','src/ai-worker.js','package-lock.json']);
 await Promise.all([

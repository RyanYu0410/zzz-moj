...
document.getElementById('tile-gallery').onclick=()=>{
 show('<h2>新艾利都 · 牌面图鉴</h2><p>万／饼／索各九张，七种字牌，三种红五。每门一张红五已加入牌山，和牌判断按普通五处理。</p><div id="tile-catalog"></div><p class="catalog-note">吃／碰为演出素材预览；副露与计分规则待接入。</p>');
